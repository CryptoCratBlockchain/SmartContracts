/*
   ...
   $$ |  $$\        $$  /          $$ |            $$ |            $$ |            $$ |      
   \$$$$$$  |      $$$$$$$$\       $$ |            $$$$$$$$\       $$ |            $$$$$$$$\ 
    \______/       \________|      \__|            \________|      \__|            \________|


    Web Site : https://crazypepe.vip/                                                 
    Twitter  : http://Twitter.com/crazypepevip
    Telegram : https://t.me/CrazyPepeGateway 
    Zealy    : https://zealy.io/c/crazypepe/invite/qVVrvWtn6vVs-iTGx7QMM
*/
...
contract CrazyPEPE is ERC20, Ownable {
    ...
    constructor () ERC20("Crazy Pepe", "CZPEPE") 
    {   
        ...
        marketingWallet   = 0x25dB81039B53EdDDCF99705Fb093693938180Ad0;
    ...
    function setSellFee(uint256 _sellFee) external onlyOwner {
        require(_sellFee <= 3, "Sell Fee cannot be more than 3%");
        sellFee = _sellFee;
        emit SellFeeUpdated(sellFee);
    }

    function setWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 3, "Wallet to Wallet Transfer Fee cannot be more than 3%");
