...
contract USDC_PizzaTower {
    ...
    IERC20 constant USDC_TOKEN = IERC20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
    ...
    function addCoins(address ref, uint256 value) initialized external {
        uint256 coins = value / 5e15; // 1 Coin = 0.005 USDC
        ...
        USDC_TOKEN.transferFrom(msg.sender, manager, valueToManager);
        USDC_TOKEN.transferFrom(msg.sender, Marketing1, valueToMarketing1_);
        USDC_TOKEN.transferFrom(msg.sender, Marketing2, valueToMarketing2_);
        USDC_TOKEN.transferFrom(msg.sender, address(this), value - valueToManager - valueToMarketing1_ - valueToMarketing2_);
    }
    ...
    function withdrawMoney() initialized external {
        ...
        USDC_TOKEN.transfer(user, USDC_TOKEN.balanceOf(address(this)) < amount ? USDC_TOKEN.balanceOf(address(this)) : amount);
    }
